<template>
  ...
  <div>
      <div style="text-align: center; font-size: 20px; margin-top: 15px;">
        <!-- A terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('A')">A</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">{{ this.gloss[1].word }}</a>
            <a href="#">{{ this.gloss[2].word }}</a>
            <a href="#">{{ this.gloss[3].word }}</a>
          </div>
        </div>

        <!-- B terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('B')">B</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- C terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('C')">C</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- D terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('D')">D</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- E terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('E')">E</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- F terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('F')">F</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- G terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('G')">G</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- H terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('H')">H</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- I terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('I')">I</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- J terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('J')">J</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- K terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('K')">K</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- L terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('L')">L</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
        ...
        <!-- M terms -->
        <div class="dropdown">
          <a class="dropbtn" onclick="getTermList('M')">M</a>
          <div class="dropdown-content">
            <a href="#">{{ term }}</a>
            <a href="#">Link 2</a>
          </div>
      ...
      <!-- N terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('N')">N</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- O terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('O')">O</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- P terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('P')">P</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- Q terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('Q')">Q</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- R terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('R')">R</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- S terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('S')">S</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- T terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('T')">T</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- U terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('U')">U</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- V terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('V')">V</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- W terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('W')">W</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- X terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('X')">X</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- Y terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('Y')">Y</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- Z terms -->
      <div class="dropdown">
        <a class="dropbtn" onclick="getTermList('Z')">Z</a>
        <div class="dropdown-content">
          <a href="#">{{ term }}</a>
          <a href="#">Link 2</a>
        </div>
      ...
      <!-- Progress Bar and Word Count -->
          ...
          <!-- Flashcard -->
          <div align="center" style="margin-top: 150px; margin-right: -300px">
            <div class="body-card">
              <label>
