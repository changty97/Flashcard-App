<template>
  <div id="app">
    ...
    <div class="topnav">
          <img id="logo" src="./assets/owp-symbol-wht.svg" class="active">
          <!-- Search Bar -->
...
label:hover .card {
  ...
  box-shadow: 0 20px 20px rgba(0, 0, 0, 0.918);
}
...
.smallLogo {
  /* background-image: url(./asset/image/owp-symbol-wht); */
  height: 45px;
}
